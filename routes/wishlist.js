...
exports.find = function(req,res,next){
  ...
  var queryText = 'SELECT distinct on(products2.kodartikulli) * FROM products2 INNER JOIN cmime2 ON (products2.kodartikulli=cmime2.idprodukti) INNER JOIN magazina ON (products2.kodartikulli=magazina.kodartikull) WHERE products2.kodartikulli IN (' + params.join(',') + ') ORDER BY products2.kodartikulli';
